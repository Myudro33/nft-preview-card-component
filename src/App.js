...
const App = () => {
  ...
  return (
    <div className="w-full h-screen bg-[#0D192C] flex justify-center items-center">
      <div className="md:w-[300px] xs:w-[90%] md:h-[510px]  xs:h-[66%] bg-[#15263f] rounded-xl p-5 flex flex-col items-center">
        <img alt="img" className="rounded-md z-0" src={img} />
        <span onMouseEnter={()=>{setBool(true)}} onMouseLeave={()=>{setBool(false)}} className="absolute bg-[#00FFF8] md:w-[260px] rounded-md opacity-0 hover:opacity-60 md:h-[260px] duration-150">
        </span>
         {bool&&( <img alt="img" className="absolute translate-y-28" src={eye} />)}
        ...
        <div className="w-full flex items-center mt-3">
          ...
          <p className="text-white font-[outfit] font-normal ml-2 hover:text-[#00FFF8]">
            Nika Qanashvili
          </p>
        </div>
      </div>
